	...
	<div class="container">
		<div class="row">
			...
			if ( $fullwidth_meta_value == '0' || $fullwidth_meta_value == '') { // If user has selected "Not Full Width" page layout, display sidebar
				echo '<section id="primary" class="content-area col-xs-12 col-sm-12 col-md-12 col-lg-8">';
			} else { // If user has selected "Full Width" page layout, hide sidebar
				echo '<section id="primary" class="content-area col-xs-12 col-sm-12 col-md-12 col-lg-12">';
			}
