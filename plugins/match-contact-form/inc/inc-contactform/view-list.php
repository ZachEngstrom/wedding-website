								...
								echo '
									<tr id="user-'.$i.'" class="'.$unreadClass.'">
										<td class="username column-username has-row-actions column-primary" data-colname="Name">
											<img alt="" src="'.esc_url( get_avatar_url( $contactResult->email ) ).'" srcset="'.esc_url( get_avatar_url( $contactResult->email ) ).' 2x" class="avatar avatar-32 photo" height="32" width="32"><strong>'.ucfirst($contactResult->firstName).' '.ucfirst($contactResult->lastName).'</strong><br>
